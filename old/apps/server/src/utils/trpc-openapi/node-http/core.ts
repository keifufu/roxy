...
import { TRPCError, type AnyProcedure } from '@trpc/server'
import {
...
import { errorFormatter } from '../../../trpc/trpc'
...
>(
  ...
  return async (req: TRequest, res: TResponse, next?: OpenApiNextFunction) => {
    ...
    try {
      ...
      sendResponse(statusCode, headers, errorFormatter(error, errorShape))
    }
  }
}